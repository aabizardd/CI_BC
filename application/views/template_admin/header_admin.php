...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?=base_url('assetsAwal/')?>img/logoo1.jpg" type="<?=base_url('assetsAwal/')?>img/logoo1.jpg">
        <title></title>
        <!-- Bootstrap CSS -->
            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light main_box">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="indexadmin.php"><img src="<?=base_url('assetsAwal/')?>img/logoo1.jpg" width="70" alt=""></a>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
                                <li class="nav-item submenu dropdown">
                                    <a href="#" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Pengelola Data Jasa</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item ">
                                            <a class="nav-link" href="<?=base_url('admin')?>">Data Jasa Clean</a>
                                        </li> 
                                        <li class="nav-item ">
                                            <a class="nav-link" href="<?=base_url('admin/beauty')?>">Data Jasa Beauty</a>
                                        </li> 
                                    </ul>
                                </li>
								<li class="nav-item">
									<a class="nav-link" href="<?=base_url('admin/dataUser')?>">Pengelola Data Pengguna</a>
								</li>
                                <li class="nav-item">
