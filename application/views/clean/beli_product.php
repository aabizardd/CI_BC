     ...
     <div class="container">
         <div class="row s_product_inner">
                         ...
                         <div class="carousel-inner">
                             <div class="carousel-item active">
                                 ...
                                 <img class="d-block w-100"
                                     src="<?php echo base_url() ?>assetsAwal/img/product/feature-product/<?=$p['gambar_clean']?>"
                                     alt="First slide">
             ...
             <div class="col-lg-5 offset-lg-1">
                 <h3><?=$p['nama_clean']?></h3>
                 <form action="<?=base_url("clean/prosesCheckout")?>" method="post">
                     <h2>Rp <?=number_format($p['harga_clean'], 2, ',', '.')?></h2>
                     <input type="hidden" name="harga" value="<?=$p['harga_clean']?>">
                     <input type="hidden" name="clean" value="<?=$p['id_clean']?>">
                     ...
                     <p>
                     <h5> <?=$p['nama_clean']?> </h5>
                     <p style="text-align: justify;"><?=$p['desc_clean']?></p>
                     <strong>Menyediakan Jasa :</strong> <br>
                     <p style="text-align: justify;"><?=$p['descmini_clean']?></p>
                     </p>
                     ...
                     <div class="product_count mt-2">
                         ...
                         <label for="qty">Luas Ruangan (Satuan Meter P x L):</label>
                         <input type="number" name="panjang" class="input-text qty"> X <input type="number" name="lebar"
