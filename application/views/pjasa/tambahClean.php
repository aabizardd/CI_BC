     ...
     <div class="main_box">
         <div class="container">
             <div class="feature_product_inner">
                 <form method="POST" action="<?=base_url('pjasa/tambahClean')?>" enctype="multipart/form-data">
                     <div class="main_title">
                         <h2>INPUT JASA CLEAN</h2>
                     </div>
                     ...
                     <table class="table">
                         <tr>
                             <td>Nama Jasa</td>
                             <td><input type="text" name="nama_jasa" class="form-control">
                                 <?=form_error('nama_jasa', '<small class="text-danger">', '</small>');?></td>
                         </tr>
                         <tr>
                             <td>Harga Jasa</td>
